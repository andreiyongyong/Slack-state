                        ...
                        @foreach ($users as $user)
                            <tr>
                                <td class="user-group" data-userid = {{$user->id}}>
                                    ...
                                    <div> <svg style="float: right" height="20" width="20">
                                    <circle cx="10" cy="13" r="7"  fill="red" />
                                    </svg>{{ $user->username }} <img class="users-circle" src="{{\App\Http\Controllers\HelperController::getAvatar($user->slack_user_id, $user->workspace_id)}}" width="50" height="50" /></div>
                                    @else
                                    <div> <svg style="float: right" height="20" width="20">
