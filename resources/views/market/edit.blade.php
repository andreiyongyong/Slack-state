                        ...
                        <div class="col-md-3">
                            <div class="form-group form-float">
                                <div>
                                    ...
                                    <select name="country" id="country" value="{{ $market->country}}" data-live-search="true">
                                    @foreach($countries as $country)
                                        <option value="{{$country->id}}" {{ $market->country == $country->id ? 'selected': ''}}>{{$country->name}}</option>
                                    @endforeach
                                    </select>
                                </div> 
